const C='fishing-os-v0.5.0-alpha4';
const A=['./','./index.html','./hotfix-alpha4.js','./app-v05.html','./manifest.json','./assets/icons/icon-180.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
