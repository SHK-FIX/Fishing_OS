...
const A=['./','./index.html','./hotfix-alpha4.js','./hotfix-alpha5.js','./hotfix-alpha6.js','./hotfix-alpha7.js','./hotfix-alpha8.js','./app-v05.html','./manifest.json','./assets/icons/icon-180.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
